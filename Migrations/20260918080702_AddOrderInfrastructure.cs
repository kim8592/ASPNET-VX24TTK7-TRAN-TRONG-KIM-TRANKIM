...
{
    /// <inheritdoc />
    public partial class AddOrderInfrastructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_DeliveryFee_NonNegative", "[DeliveryFee] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SugarPercentage = table.Column<int>(type: "int", nullable: true),
                    IcePercentage = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItemTopping_UnitPrice_NonNegative", "[UnitPrice] >= 0");
                    table.ForeignKey(
